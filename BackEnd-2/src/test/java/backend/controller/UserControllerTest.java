...
public class UserControllerTest {
    ...
    @Test
    public void isOneCalendarTest() throws Exception {
        Mockito.when(mockRepo.findByUsername(any())).thenReturn(tmpUser);
        this.mockMvc.perform(get("/users/isThereOneCalendar").with(user("user"))).andExpect(status().isOk());
    }
    @Test
    public void isOneCalendarnotWorkingTest() throws Exception {
        this.mockMvc.perform(get("/users/isThereOneCalendar").with(user("user"))).andExpect(status().isOk());
    }
    @Test
    ...
    public void getEventsTest() throws Exception {
        ...
        this.mockMvc.perform(post("/users/getEvents").content(asJsonString(tmp)).contentType(MediaType.APPLICATION_JSON)
                .accept(MediaType.APPLICATION_JSON).with(user("user"))).andExpect(status().isOk());
    }
