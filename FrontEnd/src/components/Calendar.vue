...
<div v-if="this.toggle" style="margin-left:49%; margin-top:10%; z-index:2; position:absolute;">
    <h1 style="text-shadow: 2px 4px 3px rgba(0,0,0,0.3);color:white;">{{this.msg}}</h1>
</div>
                    ...
                    if (arrayLength == 0) {
                        ...
                        for (var i = 0; i < arrayLength; i++) {
                            ...
                            var x = {
                                ...
                                avg: eventsArr[i].pulseAverage,
                                tag: eventsArr[i].tag,
                                avgHRV: avgH,
                                desc0: 'Average heart rate :' + eventsArr[i].pulseAverage,
                                desc1: 'Type: ' + eventsArr[i].tag,
                                desc2: this.heartStats(eventsArr[i].tag, eventsArr[i].pulseAverage, 30),
                                id: eventsArr[i].id,
